...
def main():
    ...
    number_packet_distributor = config_params["number_packet_distributor"]
    ...
    logging.debug(f"action: config | result: success | logging_level: {logging_level} |"
                  f"number_packet_distributor: {number_packet_distributor} ")

    try:
        eof_manager = EOFManager(number_packet_distributor)
        eof_manager.run()
    except OSError as e:
